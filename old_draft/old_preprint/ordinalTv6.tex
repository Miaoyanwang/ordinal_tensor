...
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{algorithm.pdf}
...
\begin{figure}[http]
\includegraphics[width=8.3cm]{panel3.pdf}
...
\begin{figure}[http]
\centering
\includegraphics[width = .5\textwidth]{HCP.pdf}
