...
Our main contributions are summarized in Table~\ref{tab:compare}. %We propose a cumulative link model, develop a rank-constrained M-estimator, and obtain theoretical accuracy guarantees. 
...
\captionof{figure}{\footnotesize  Trajectory of objective function with the input tensor generated from probit model~\eqref{eq:model} with $d_1=d_2=d_3=d$ and $r_1=r_2=r_3=r$. The dashed line is the objective value at the true parameter $\logl(\trueT)$.}
\end{minipage}
