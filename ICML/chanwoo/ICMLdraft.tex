...
\toprule
 Method & MSE & MAD & MCR \\
\midrule
\begin{tabular}[c]{@{}c@{}}Oridnal tensor\\ Decomposition\end{tabular}  & 0.1503 & 0.1502& 0.1502\\ \\
\begin{tabular}[c]{@{}c@{}}Conti tensor\\ Decomposition\end{tabular} & 0.1603& 0.1600& 0.1598\\ \\
\begin{tabular}[c]{@{}c@{}}1bit-completion\\ (probit)\end{tabular}  & 0.3658 & 0.3632 & 0.3619\\
\begin{tabular}[c]{@{}c@{}}1bit-completion\\ (logistic)\end{tabular}  &  0.4514 & 0.4215 & 0.4066
\\
\bottomrule
\end{tabular}
\end{sc}
