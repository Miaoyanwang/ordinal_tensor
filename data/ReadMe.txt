...
Two goals:
1. tensor completion: offer music recommendations to users. 
...
Data file (edge): A user-specified input. This is a matrix file representing the brain connection. The connection can be raw edges, estimated edges, truncated edges, or any edges you want to plot over brains. I included a gender.txt file as an example.
